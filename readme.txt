...
8. Enter the complete URL to the image, including the `http://`
* Optional: Enter `ALT` text for the image
...
NB: This plugin will not resize your images, please make sure you use an appropriate sized image for the area you are placing it. For the "fixed position" it is strongly recommended to use an image that is at least partially transparent for those readers with smaller screens. 
